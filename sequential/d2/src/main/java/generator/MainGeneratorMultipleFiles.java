...
/**
 * The <samp>MainGeneratorMultipleFiles</samp> generates multiple files of random
...
public class MainGeneratorMultipleFiles {
	...
	/**
	 * The <samp>main(String[])</samp> method deals with generating multiple files
	 * of k-mer - occurrences couples.<br />
	 ...
	 *   <li>the output directory for sequences files, terminating with '//'</li>
	 *   <li>the size in MB of the buffer for writing processes <em>(optional)</em></li>
	 * </ol>
	 *
